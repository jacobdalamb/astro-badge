...
export const GET: InferStaticAPIRoute<typeof getStaticPaths> = ({ params }) => {
	const body = `<svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" enable-background="new 0 0 1200 220" viewBox="0 0 1200 220" width="${
		sizes[params.size]
	}">
